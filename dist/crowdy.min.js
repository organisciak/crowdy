...
!function() {
    ...
    b.forms = {}, b.condition = null, b.performanceFeedback = null, b.time = {
        estimate: null
    ...
    b.p.conditionalPostLoadPrep || (b.p.conditionalPostLoadPrep = function() {
        ...
        ("fast" !== b.design || "feedback" === b.phase) && (b.forms.turkForm.$valid ? h.post(b.BACKEND_SERVER + "/save/hit", b.taskset).success(function(a) {
            i(a, null);
        }).error(function(a) {
